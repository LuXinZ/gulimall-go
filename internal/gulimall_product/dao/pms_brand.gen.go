...
func newPmsBrand(db *gorm.DB, opts ...gen.DOOption) pmsBrand {
	...
	_pmsBrand.BrandID = field.NewInt64(tableName, "brand_id")
	_pmsBrand.Name = field.NewString(tableName, "name")
	_pmsBrand.Logo = field.NewString(tableName, "logo")
	_pmsBrand.Descript = field.NewString(tableName, "descript")
...
type pmsBrand struct {
	...
	Name        field.String // 品牌名
	Logo        field.String // 品牌logo地址
	Descript    field.String // 介绍
	ShowStatus  field.Int32  // 显示状态[0-不显示；1-显示]
	FirstLetter field.String // 检索首字母
	Sort        field.Int32  // 排序
...
func (p pmsBrandDo) Session(config *gorm.Session) *pmsBrandDo {
